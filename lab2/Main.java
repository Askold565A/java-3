...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        arrayListControl2.Add(new Game("CS:GO",10, true));
        arrayListControl2.Add(new Game("Killing Floor",10, false));
        arrayListControl2.Add(new Game("True Crime City",5, true));
        ...
        linkedList.Add(game);
        linkedList.Add(new Game("CS:GO",10, true));
        linkedList.Show();
        System.out.print("\n");
        ...
        linkedList.Show();
        System.out.print("\n");
        Game game2 = new Game("Killing Floor",10, false);
        Game game3 = new Game("True Crime City",5, true);
        System.out.print("\nAdding one object (Killing Floor)\n");
        ...
        System.out.print(linkedList.Size());
        System.out.print("\n");
        System.out.print("Checking if contains object (True Crime City)\n");
